...
public class MergeSortingJustPratice {
//    public void mergeSortArray(int low,int high,int [] array){
//        //int mid=(low+high)/2;
//        if(low<high){
//            int mid=(low+high)/2;
//            mergeSortArray(low,mid-1,array);
//            mergeSortArray(mid,high,array);
//            mergeOperation(low,mid,high,array);
//        }
//
//    }
//    public void mergeOperation(int low,int mid,int high,int [] array){
//        //int []array=new int[];
//        int starting =low;
//        int end=high;
//        int size=high+low-1;
